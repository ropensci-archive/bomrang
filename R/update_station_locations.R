...
#'
#' If \code{\link[ASGS.foyer]{ASGS.foyer}} is installed locally, this function
#' will automatically check and correct any invalid state values for stations
#' located in Australia. If \code{\link[ASGS.foyer]{ASGS.foyer}} is not
#' installed, the function will update the internal database without validating
#' the state values for stations by reported lon/lat location.
#'
#' @examples
#' \dontrun{
