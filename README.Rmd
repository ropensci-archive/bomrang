...
* **sort_order** - 
* **wmo** - World Meteorological Organization (WMO) assigned a 5-character alpha-numeric station identifier  
...
* **lat** -
* **lon** -
* **apparent_t** - Steadman Apparent Temperature. May also be referred as AT in other observation products. (degrees Celsius)
* **cloud** -
* **cloud_type** -
* **delta_t** - Delta-T is Wet Bulb Depression (Air Temperature - Wet Bulb Temperature).(Not included for Antarctic observations)  (degrees Celsius)
* **gust_kmh** -
* **gust_kt** -
* **air_temp** -
* **dewpt** - Temperature to which air must be cooled for dew to form. (degrees Celsius)  
* **press** -
* **press_msl** -
* **press_qnh** -
* **press_tend** -
...
* **vis_km** -
* **weather** -
* **wind_dir** - Wind Direction. Direction relative to True North, from which the wind is blowing. (16 Compass Points)
* **wind_spd_kmh** - Wind observations averaged over 10 minutes. (kilometres per hour)
* **wind_spd_kt** - Wind observations averaged over 10 minutes. (knots)
