...
your choice. To fetch an individual state, simply use the official postal code
...
The function, `get_forecast()` will return a Tibble of the weather forecast for the
next six days with the following fields.
