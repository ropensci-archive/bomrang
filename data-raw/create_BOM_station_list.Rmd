...
JSON files for stations and corresponding metadata, e.g., latitude, longitude
...
```
## Save data
Now that we have the dataframe of stations and have generated the URLs for the
