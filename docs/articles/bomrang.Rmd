...
bulletin; and `get_weather_bulletin()` which fetches the 0900 and 1500 weather
bulletins. A second family of functions retrieve information pertaining to
...
unless you know that a station exists in BoM's database that is not available in the databases distributed with _bomrang_
