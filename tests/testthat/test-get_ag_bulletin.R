...
test_that("get_ag_bulletin returns 26 columns", {
  skip_on_cran()
  BOM_bulletin <- get_ag_bulletin(state = "QLD")
  expect_equal(ncol(BOM_bulletin), 26)
  expect_named(
    BOM_bulletin,
    c(
      "obs_time_local",
