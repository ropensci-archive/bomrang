...
test_that("Error handling", {
  ...
  expect_error(get_historical(stationid = "sodiuhfosdhfoisdh"),
               regexp = "Station not recognised")
  expect_error(get_historical(stationid = 1),
               regexp = "Station not recognised.")
  expect_error(get_historical(stationid = "1"),
               regexp = "Station not recognised.")
  expect_error(get_historical(stationid = "023001"),
               regexp = "Station not recognised.")
  ...
  expect_error(get_historical(stationid = "023000",
                              type = "sodiuhfosdhfoisdh")
