...
test_that("Error handling", {
  ...
  expect_error(get_historical("sodiuhfosdhfoisdh"), regexp = "Station not recognised")
...
test_that("Query stationid = '023000', type = 'rain' returns data.frame w/ correct station and some data", {
...
test_that("Query latlon = c(-34.9285, 138.6007), type = 'rain' returns data.frame w/ correct station and some data", {
