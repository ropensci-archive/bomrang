...
This function downloads the latest station locations and metadata and updates bomrang's internal database.  There is no need to use this unless you know that a station exists in BOM's database that is not available in the database distributed with _bomrang_
