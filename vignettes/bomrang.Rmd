...
and radar imagery files are also made available to the public via anonymous ftp.
_bomrang_ provides functionality to query, fetch and create `raster::stack()`
...
and the imagery itself, `get_satellite_imagery()` for satellite, and
