...
## Retrieving with satellite imagery
...
- **IDE00425** AHI VIS (true colour) / IR (Ch13 greyscale) composite 1km FD GEOS
GIS

- **IDE00426** AHI VIS (true colour) / IR (Ch13 greyscale) composite 2km FD GEOS
GIS
...
- **IDE00435** AHI VIS (true colour) / IR (Ch13 greyscale) composite 1km AUS
equirect. GIS

- **IDE00436** AHI VIS (true colour) / IR (Ch13 greyscale) composite 2km AUS
equirect. GIS
...
`get_available_imagery()` only takes one argument, `product_id`, a BoM identfier
