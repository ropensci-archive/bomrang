...
#>   2:        Coen Ap      NA        E              4
#>   3:        Horn Is       8        E             20
#>   4: Lockhart River       4        E             13
#>   5:    Palmerville      NA      ENE              9
#>  ---                                               
#> 133:         Hobart      NA        E              9
#> 134:       Adelaide      NA        W              6
#> 135:       Perth Ap      NA        E             24
#> 136:         Darwin       2      NNW             11
#> 137:  Alice Springs      NA        E             20
...
#> Data saved as /tmp/RtmpYCe7bf/IDCJAC0011_070351_1800_Data.csv
...
#>   ---                                           
#> 4374:   IDCJAC0011          70351 2019    12  22
#> 4375:   IDCJAC0011          70351 2019    12  23
#> 4376:   IDCJAC0011          70351 2019    12  24
#> 4377:   IDCJAC0011          70351 2019    12  25
#> 4378:   IDCJAC0011          70351 2019    12  26
...
#>      site dist                              name
#> 1  070351   70                  CANBERRA AIRPORT
#> 2  070339   70 TUGGERANONG (ISABELLA PLAINS) AWS
#> 3  070349   70                  MOUNT GININI AWS
#> 4  070341   70 CAPTAINS FLAT (COWANGERONG RADAR)
#> 5  069132   69          BRAIDWOOD RACECOURSE AWS
#> 6  070358   70         YASS (RURAL FIRE SERVICE)
#> 7  073007   73                    BURRINJUCK DAM
#> 8  070330   70              GOULBURN AIRPORT AWS
#> 9  070263   70                     GOULBURN TAFE
#> 10 069128   69                       NERRIGA AWS
#>    start  end      lat      lon state  elev bar_ht
#> 1   2008 2019 -35.3088 149.2004   ACT 577.1  577.6
#> 2   1996 2019 -35.4184 149.0937   ACT 586.7  587.5
#> 3   2004 2019 -35.5293 148.7721   ACT 760.0     NA
#> 4   2002 2019 -35.6614 149.5122   NSW 358.0     NA
#> 5   1985 2019 -35.4253 149.7835   NSW 665.2  666.0
#> 6   2011 2019 -34.8225 148.9080   NSW 498.0     NA
#> 7   1908 2019 -34.9997 148.5984   NSW 390.0     NA
#> 8   1988 2019 -34.8085 149.7311   NSW 640.0  640.8
#> 9   1971 2019 -34.7495 149.7034   NSW 670.0     NA
#> 10  2013 2019 -35.1103 150.0826   NSW 622.0  625.6
#>      wmo state_code
#> 1  94926       <NA>
#> 2  94925       <NA>
#> 3  95925       <NA>
...
#> 6  http://www.bom.gov.au/fwo/IDN60801/IDN60801.95723.json
#> 7  http://www.bom.gov.au/fwo/IDN60801/IDN60801.94909.json
#> 8  http://www.bom.gov.au/fwo/IDN60801/IDN60801.95716.json
#> 9  http://www.bom.gov.au/fwo/IDN60801/IDN60801.94716.json
#> 10 http://www.bom.gov.au/fwo/IDN60801/IDN60801.94943.json
#>      distance
#> 1   0.9791884
#> 2  16.3172787
#> 3  46.4084466
...
#>          aac              town      lon       lat
#> 1  NSW_PT027          Canberra 149.2003 -35.30880
#> 2  NSW_PT235        Queanbeyan 149.2346 -35.34850
#> 3  NSW_PT329 Portable RFSACT03 149.3162 -35.31110
#> 4  NSW_PT281      Woden Valley 149.0845 -35.34844
#> 5  NSW_PT254         Belconnen 149.0677 -35.23538
#> 6  NSW_PT267         Gungahlin 149.1376 -35.18473
#> 7  NSW_PT146       Tuggeranong 149.0953 -35.41860
#> 8  NSW_PT327 Portable RFSACT01 148.9301 -35.45950
#> 9  NSW_PT328 Portable RFSACT02 148.8485 -35.10660
#> 10 NSW_PT093      Mount Ginini 148.7725 -35.52930
#>      elev  distance
#> 1   577.6  0.978894
#> 2   612.0  6.239984
#> 3   719.0 10.616459
...
#>   [1] "IDE00425.201912242310.tif"
#>   [2] "IDE00425.201912242320.tif"
#>   [3] "IDE00425.201912242330.tif"
#>   [4] "IDE00425.201912242340.tif"
#>   [5] "IDE00425.201912242350.tif"
#>   [6] "IDE00425.201912250000.tif"
#>   [7] "IDE00425.201912250010.tif"
#>   [8] "IDE00425.201912250020.tif"
#>   [9] "IDE00425.201912250030.tif"
#>  [10] "IDE00425.201912250040.tif"
#>  [11] "IDE00425.201912250050.tif"
#>  [12] "IDE00425.201912250100.tif"
#>  [13] "IDE00425.201912250110.tif"
#>  [14] "IDE00425.201912250120.tif"
#>  [15] "IDE00425.201912250130.tif"
#>  [16] "IDE00425.201912250140.tif"
#>  [17] "IDE00425.201912250150.tif"
#>  [18] "IDE00425.201912250200.tif"
#>  [19] "IDE00425.201912250210.tif"
#>  [20] "IDE00425.201912250220.tif"
#>  [21] "IDE00425.201912250230.tif"
#>  [22] "IDE00425.201912250250.tif"
#>  [23] "IDE00425.201912250300.tif"
#>  [24] "IDE00425.201912250310.tif"
#>  [25] "IDE00425.201912250320.tif"
#>  [26] "IDE00425.201912250330.tif"
#>  [27] "IDE00425.201912250340.tif"
#>  [28] "IDE00425.201912250350.tif"
#>  [29] "IDE00425.201912250400.tif"
#>  [30] "IDE00425.201912250410.tif"
#>  [31] "IDE00425.201912250420.tif"
#>  [32] "IDE00425.201912250430.tif"
#>  [33] "IDE00425.201912250440.tif"
#>  [34] "IDE00425.201912250450.tif"
#>  [35] "IDE00425.201912250500.tif"
#>  [36] "IDE00425.201912250510.tif"
#>  [37] "IDE00425.201912250520.tif"
#>  [38] "IDE00425.201912250530.tif"
#>  [39] "IDE00425.201912250540.tif"
#>  [40] "IDE00425.201912250550.tif"
#>  [41] "IDE00425.201912250600.tif"
#>  [42] "IDE00425.201912250610.tif"
#>  [43] "IDE00425.201912250620.tif"
#>  [44] "IDE00425.201912250630.tif"
#>  [45] "IDE00425.201912250640.tif"
#>  [46] "IDE00425.201912250650.tif"
#>  [47] "IDE00425.201912250700.tif"
#>  [48] "IDE00425.201912250710.tif"
#>  [49] "IDE00425.201912250720.tif"
#>  [50] "IDE00425.201912250730.tif"
#>  [51] "IDE00425.201912250740.tif"
#>  [52] "IDE00425.201912250750.tif"
#>  [53] "IDE00425.201912250800.tif"
#>  [54] "IDE00425.201912250810.tif"
#>  [55] "IDE00425.201912250820.tif"
#>  [56] "IDE00425.201912250830.tif"
#>  [57] "IDE00425.201912250840.tif"
#>  [58] "IDE00425.201912250850.tif"
#>  [59] "IDE00425.201912250900.tif"
#>  [60] "IDE00425.201912250910.tif"
#>  [61] "IDE00425.201912250920.tif"
#>  [62] "IDE00425.201912250930.tif"
#>  [63] "IDE00425.201912250940.tif"
#>  [64] "IDE00425.201912250950.tif"
#>  [65] "IDE00425.201912251000.tif"
#>  [66] "IDE00425.201912251010.tif"
#>  [67] "IDE00425.201912251020.tif"
#>  [68] "IDE00425.201912251030.tif"
#>  [69] "IDE00425.201912251040.tif"
#>  [70] "IDE00425.201912251050.tif"
#>  [71] "IDE00425.201912251100.tif"
#>  [72] "IDE00425.201912251110.tif"
#>  [73] "IDE00425.201912251120.tif"
#>  [74] "IDE00425.201912251130.tif"
#>  [75] "IDE00425.201912251140.tif"
#>  [76] "IDE00425.201912251150.tif"
#>  [77] "IDE00425.201912251200.tif"
#>  [78] "IDE00425.201912251210.tif"
#>  [79] "IDE00425.201912251220.tif"
#>  [80] "IDE00425.201912251230.tif"
#>  [81] "IDE00425.201912251240.tif"
#>  [82] "IDE00425.201912251250.tif"
#>  [83] "IDE00425.201912251300.tif"
#>  [84] "IDE00425.201912251310.tif"
#>  [85] "IDE00425.201912251320.tif"
#>  [86] "IDE00425.201912251330.tif"
#>  [87] "IDE00425.201912251340.tif"
#>  [88] "IDE00425.201912251350.tif"
#>  [89] "IDE00425.201912251400.tif"
#>  [90] "IDE00425.201912251410.tif"
#>  [91] "IDE00425.201912251420.tif"
#>  [92] "IDE00425.201912251430.tif"
#>  [93] "IDE00425.201912251450.tif"
#>  [94] "IDE00425.201912251500.tif"
#>  [95] "IDE00425.201912251510.tif"
#>  [96] "IDE00425.201912251520.tif"
#>  [97] "IDE00425.201912251530.tif"
#>  [98] "IDE00425.201912251540.tif"
#>  [99] "IDE00425.201912251550.tif"
#> [100] "IDE00425.201912251600.tif"
#> [101] "IDE00425.201912251610.tif"
#> [102] "IDE00425.201912251620.tif"
#> [103] "IDE00425.201912251630.tif"
#> [104] "IDE00425.201912251640.tif"
#> [105] "IDE00425.201912251650.tif"
#> [106] "IDE00425.201912251700.tif"
#> [107] "IDE00425.201912251710.tif"
#> [108] "IDE00425.201912251720.tif"
#> [109] "IDE00425.201912251730.tif"
#> [110] "IDE00425.201912251740.tif"
#> [111] "IDE00425.201912251750.tif"
#> [112] "IDE00425.201912251800.tif"
#> [113] "IDE00425.201912251810.tif"
#> [114] "IDE00425.201912251820.tif"
#> [115] "IDE00425.201912251830.tif"
#> [116] "IDE00425.201912251840.tif"
#> [117] "IDE00425.201912251850.tif"
#> [118] "IDE00425.201912251900.tif"
#> [119] "IDE00425.201912251910.tif"
#> [120] "IDE00425.201912251920.tif"
#> [121] "IDE00425.201912251930.tif"
#> [122] "IDE00425.201912251940.tif"
#> [123] "IDE00425.201912251950.tif"
#> [124] "IDE00425.201912252000.tif"
#> [125] "IDE00425.201912252010.tif"
#> [126] "IDE00425.201912252020.tif"
#> [127] "IDE00425.201912252030.tif"
#> [128] "IDE00425.201912252040.tif"
#> [129] "IDE00425.201912252050.tif"
#> [130] "IDE00425.201912252100.tif"
#> [131] "IDE00425.201912252110.tif"
#> [132] "IDE00425.201912252120.tif"
#> [133] "IDE00425.201912252130.tif"
#> [134] "IDE00425.201912252140.tif"
#> [135] "IDE00425.201912252150.tif"
#> [136] "IDE00425.201912252200.tif"
#> [137] "IDE00425.201912252210.tif"
#> [138] "IDE00425.201912252220.tif"
#> [139] "IDE00425.201912252230.tif"
#> [140] "IDE00425.201912252240.tif"
#> [141] "IDE00425.201912252250.tif"
#> [142] "IDE00425.201912252300.tif"
#> [143] "IDE00425.201912252310.tif"
#> [144] "IDE00425.201912252320.tif"
#> [145] "IDE00425.201912252330.tif"
#> [146] "IDE00425.201912252340.tif"
#> [147] "IDE00425.201912252350.tif"
#>   [1] "IDE00425.201912242310.tif"
#>   [2] "IDE00425.201912242320.tif"
#>   [3] "IDE00425.201912242330.tif"
#>   [4] "IDE00425.201912242340.tif"
...
#>    Latitude Radar_id                Full_Name
#> 1 -37.69100        1 Melbourne (Broadmeadows)
#> 2 -37.69100        1 Melbourne (Broadmeadows)
#> 3 -37.69100        1 Melbourne (Broadmeadows)
#> 4 -37.69100        1 Melbourne (Broadmeadows)
#> 5 -37.85525        2     Melbourne (Laverton)
#> 6 -37.85525        2     Melbourne (Laverton)
#>   IDRnn0name IDRnn1name State    Type Group    Status
#> 1     CampRd     CampRd   VIC Doppler   Yes Reg_users
#> 2     CampRd     CampRd   VIC Doppler   Yes Reg_users
#> 3     CampRd     CampRd   VIC Doppler   Yes Reg_users
#> 4     CampRd     CampRd   VIC Doppler   Yes Reg_users
#> 5       Melb  Melbourne   VIC Doppler   Yes    Public
#> 6       Melb  Melbourne   VIC Doppler   Yes    Public
#>   Archive
#> 1  CampRd
#> 2  CampRd
#> 3  CampRd
...
#> file downloaded to:/tmp/RtmpYCe7bf/file78c829f6c69e.gif
...
#> Data saved as /tmp/RtmpYCe7bf/IDCJAC0010_023000_1800_Data.csv
adlmax
#>   ---- Australian Bureau of Meteorology (BOM) Data Resource ----
#>   (Original Request Parameters)
...
#>    ---                                           
#> 48567:   IDCJAC0010          23000 2019    12  21
#> 48568:   IDCJAC0010          23000 2019    12  22
#> 48569:   IDCJAC0010          23000 2019    12  23
#> 48570:   IDCJAC0010          23000 2019    12  24
#> 48571:   IDCJAC0010          23000 2019    12  25
