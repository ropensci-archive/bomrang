...
dplyr methods, e.g. `mutate`, `filter`, `select`, `arrange`, `slice`, `rename`, and 
`group_by` while preserving the header information.
...
```{r historical_data, message=FALSE}
library(magrittr)
...
```{r completeness_map, , fig.width = 7, fig.height = 5, message = FALSE}
...
```{r years_available, fig.width = 7, fig.height = 5, message = FALSE}
